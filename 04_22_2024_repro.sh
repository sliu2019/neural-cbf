...
# TODO: above not correct with p_reuse = 0.5

# 5 PM EST 
nohup python -u main.py --reg_transform "sigmoid" --reg_sampler "random_inside" --reg_weight 150.0 --objective_option "weighted_average" --phi_nnl "tanh-tanh-softplus" --phi_nn_inputs "euc" --phi_include_xe --critic_n_samples 500 --critic_max_n_steps 20 --random_seed 0 --affix "repro_after_critic_param" --gpu 1 &> repro_after_critic_param.out &
...
# 6:30 PM EST
nohup python -u main.py --reg_weight 150.0 --critic_n_samples 500 --critic_max_n_steps 20 --random_seed 0 --affix "repro_after_phi_param" --gpu 2 &> repro_after_phi_param.out &