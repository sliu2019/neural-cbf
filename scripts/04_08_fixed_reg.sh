...
nohup python main.py --reg_transform "sigmoid" --reg_sampler "random_inside" --reg_weight 125.0 --objective_option "weighted_average" --phi_nnl "tanh-tanh-softplus" --phi_nn_inputs "euc" --phi_include_xe --critic_n_samples 100 --critic_use_n_step_schedule --critic gradient_batch_warmstart_faster --gradient_batch_warmstart_faster_speedup_method sequential --gradient_batch_warmstart_faster_sampling_method gaussian --random_seed 0 --affix "ESG_reg_speedup_weight_125_seed_0" --gpu 2 &> ESG_reg_speedup_weight_125_seed_0.out &
