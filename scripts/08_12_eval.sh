...
# CMAES, LQR, q = 0.1
nohup python -u run_flying_pend_exps.py --save_fnm LQR_q_1e_1_long --which_cbf low-CMAES --exp_name_to_load flying_pend_new_init --checkpoint_number_to_load 10 --which_experiments rollout --rollout_u_ref LQR --rollout_T_max 2.5 --run_length long --rollout_LRQ_q 0.1 &> lqr_cmaes_q_1e_1.out &

# CMAES, LQR, q = 1.0
nohup python -u run_flying_pend_exps.py --save_fnm LQR_q_1_long --which_cbf low-CMAES --exp_name_to_load flying_pend_new_init --checkpoint_number_to_load 10 --which_experiments rollout --rollout_u_ref LQR --rollout_T_max 2.5 --run_length long --rollout_LRQ_q 1.0 &> lqr_cmaes_q_1_long.out &

# CMAES, un-actuated
nohup python -u run_flying_pend_exps.py --save_fnm unactuated_long --which_cbf low-CMAES --exp_name_to_load flying_pend_new_init --checkpoint_number_to_load 10 --which_experiments rollout --rollout_u_ref unactuated --rollout_T_max 2.5 --run_length long &> unactuated_long.out &
