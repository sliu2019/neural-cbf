...
nohup python -u run_flying_pend_exps.py --save_fnm ckpt_490_vol_grid --which_cbf ours --exp_name_to_load flying_inv_pend_best_reg_weight_100 --checkpoint_number_to_load 490 --which_experiments volume --volume_alg bfs_grid --bfs_axes_grid_size 0.23 0.23 0.70 3.33 3.33 3.33 0.23 0.23 3.33 3.33  &> reg_weight_100_vol_grid.out &

nohup python -u run_flying_pend_exps.py --save_fnm ckpt_490_vol_sample --which_cbf ours --exp_name_to_load flying_inv_pend_best_reg_weight_100 --checkpoint_number_to_load 490 --which_experiments volume --volume_alg sample --N_samp_volume 2500000 &> reg_weight_100_vol_sample.out &
