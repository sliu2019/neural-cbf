...
nohup python main.py --problem flying_inv_pend --no_softplus_on_obj --reg_weight 0.0 --phi_include_beta_deriv --phi_include_xe --train_attacker_n_samples 30 --train_attacker_max_n_steps 30 --train_attacker_projection_lr 1e-2 --trainer_stopping_condition n_steps --trainer_n_steps 3000 --affix iterated_beta --gpu 0 &> iterated_beta.out &

nohup python main.py --problem flying_inv_pend --no_softplus_on_obj --reg_weight 0.0 --phi_include_beta_deriv --phi_include_xe --train_attacker_n_samples 30 --train_attacker_max_n_steps 30 --train_attacker_projection_lr 1e-2 --trainer_stopping_condition n_steps --trainer_n_steps 3000 --affix flat_beta --gpu 0 &> flat_beta.out &


nohup python main.py --problem flying_inv_pend --pend_length 9.0 --no_softplus_on_obj --reg_weight 0.0 --phi_include_beta_deriv --phi_include_xe --train_attacker_n_samples 60 --train_attacker_max_n_steps 30 --train_attacker_projection_lr 1e-2 --trainer_stopping_condition n_steps --trainer_n_steps 3000 --affix iterated_beta_pend_len_9 --gpu 1 &> iterated_beta_pend_len_9.out &
